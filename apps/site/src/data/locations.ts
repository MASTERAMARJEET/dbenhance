...
export const LOCATIONS: Record<CityId, SalonLocation> = {
  bangalore: {
    ...
    hours: [
      {
        label: "All days except Tuesday",
        time: "10:00 AM - 9:00 PM",
      },
      { label: "Tuesday", time: "Closed" },
    ],
  },
  chennai: {
    id: "chennai",
    ...
    hours: [
      { label: "Monday - Friday", time: "10:00 AM - 9:00 PM" },
      { label: "Saturday & Sunday", time: "9:00 AM - 9:00 PM" },
    ],
  },
};
...
export function whatsappUrl(
  location: SalonLocation = getDefaultLocation(),
): string {
